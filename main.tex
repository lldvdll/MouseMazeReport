\documentclass[aps,pre,superscriptaddress,twocolumn,longbibliography,floatfix,10pt]{revtex4-2}
...
\input{sections/sudden_insight}
\input{sections/weird_behaviour}
\input{sections/exploration_biases}
\input{sections/Memory capacities}
\input{sections/reward_based_model}
\input{sections/dopamine}
